...
public class CustomObjectBubbleSortWithComparator {
    public static void main(String[] args) {
        ...
        bubbleSortCustomObjectsWithComparator(people, Comparator.comparing(Person::getAge));
        System.out.println("Sorted Array by Age: " + Arrays.toString(people));
    }

    public static void bubbleSortCustomObjectsWithComparator(Object[] arr, Comparator<Object> comparator) {
